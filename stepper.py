...
mymotortest.motor_run(GPIOX_pins , 0.005, 60, False, False, "half", .05)
mymotortest.motor_run(GPIOX_pins , 0.005, 60, True, False, "half", .05)

mymotortest.motor_run(GPIOZ_pins , 0.005, 60, False, False, "half", .05)
mymotortest.motor_run(GPIOZ_pins , 0.005, 60, True, False, "half", .05)
